...
<div class="container my-5">
    ...
    <form action="" method="POST" class="row g-1">
        ...
        <div class="col-6 col-md-3">
            <label for="heated_area" class="form-label small">Isitiladigan maydon (m²)</label>
        ...
        <!-- Tashqi deraza turi -->
        <div class="col-3">
            <label for="window_layer" class="form-label small">Tashqi deraza turi</label>
        ...
        <!-- Har bir bo'lim uchun tabellar -->
        <!-- 1) Tashqi devor turi -->
        <h3 class="mt-5">Tashqi devor turi</h3>

        <div class="row mb-3">
            <label for="wall_type" class="col-sm-4 col-form-label">Tashqi devor turi</label>
            <div class="col-sm-8">
        ...
        <h3 class="mt-4">Tashqi eshik turi</h3>
        <div class="row mb-3">
            <label for="wall_type" class="col-sm-4 col-form-label">Tashqi devor turi</label>
            <div class="col-sm-8">
        ...
        <h3 class="mt-4">Tom yopma turi</h3>
        <div class="row mb-3">
            <label for="wall_type" class="col-sm-4 col-form-label">Tom yopma turi</label>
            <div class="col-sm-8">
